...
export default function AddOns({ addOns, setAddOns, setActiveTab, isMonthly, setSummaryLock }) {
  ...
  return (
    <div className="flex flex-col min-h-[70vh] max-md:pb-20 h-full max-md:max-h-screen max-md:pb-20 justify-between relative">
      <div>
        <h1 className="text-2xl font-bold mb-2">Pick Add-Ons</h1>
        <p className="text-gray-500 mb-6">Add-ons help enhance your experience.</p>
